     ...
     <div id = "profileForm" class="box" style="display:none">
		...
		<div id="orange">
			<div align="center" id="current_avatar">
				...
				<p class="para">Choose your favourite avatar</p>
				...
				<p class="para">An avatar image file should be a maximum 50x50px PNG, JPEG or GIF image that is smaller than 15 KB</p>
				<div class="clear"></div>
