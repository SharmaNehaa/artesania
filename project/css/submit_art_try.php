			...
			<div id ="main">
				...
				<div id = "content">
					<form id="uploadInfo" name="uploadInfo" action="submitphp.php" method="post" enctype="multipart/form-data">
						...
						<select id="subcat" label="Sub-Category">
						...
						<form id="sale" style="display:none;" action="#" method="post" enctype="multipart/form-data">
							<div>
								<input type="text" name="price" placeholder="Price"></input><br>
								<input type="text" name="size" placeholder="Size"></input>
							</div>
						</form>
						<form action="submitphp.php" method="post" enctype="multipart/form-data">
