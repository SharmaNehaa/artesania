...
<body>
	<?php
		...
		if(isset($row2['artist']) && isset($row2['movie']) && isset($row2['band_music']) && isset($row2['book']) && isset($row2['writer']) && isset($row2['cuisine']) && isset($row2['fashion_brand']) && isset($row2['fashion_designer']) && isset($row2['painter']) && isset($row2['category'])  && isset($row2['subcategory'])) {
			if($row['gender']=="male" || $row['gender']=="Male")
